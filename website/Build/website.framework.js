...
var ASM_CONSTS = {
  4348512: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4348573: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4348637: function() {return Module.webglContextAttributes.powerPreference;},  
 4348695: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4348750: function($0) {performance.now = function() { return $0; };},  
 4348798: function($0) {performance.now = function() { return $0; };},  
 4348846: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _WebSocketInit() {
      const reconnectInterval = 1000; // Interval to wait before trying to reconnect (in milliseconds)
      const url = "ws://localhost:5000";
  
      /**
       * Handles WebSocket events such as onopen, onmessage, and onclose.
       * @param {WebSocket} ws - The WebSocket instance.
       */
      function handleWebSocketEvents(ws) {
        ws.onopen = function() {
          console.log('WebSocket connection opened.');
        };
  
        ws.onmessage = function(event) {
          Module.SendMessage('CommunicationHandler', 'RunCommand', event.data);
        };
      ...
      /**
       * Creates a new WebSocket connection and sets up event handling.
       */
      ...
      /**
       * Schedules a reconnection attempt after the specified interval.
       */
  ...
  function _WebSocketSend(message) {
      ...
      if (Module.ws && Module.ws.readyState === WebSocket.OPEN) {
        ...
        console.log('WebSocket is not open. Message not sent: ', msg);
      }
    }
